  ...
  return (
    <div className="TopContainer">
      <div className="TopContents">
        <div className="TopText">Best Website builders in the US</div>
        ...
        <div className="TopHolders">
          <div className="TopItem">
            ...
            <div className="TopTexts">Last Updated</div>
            <div className="TopTexts">-</div>
            <div className="TopTexts" style={{ paddingRight: "50px" }}>
              February 22, 2020
            </div>
            <svg
              style={{ paddingRight: "10px" }}
            ...
            <div className="TopTexts">Advertising Disclosure</div>
          </div>
          <div className="TopFilterContainer">
            <div className="TopFilter">Top Relevant</div>
            <svg
              style={{ paddingRight: "10px" }}
              className="TopIcon"
              width="24"
      ...
      <div className="TopTexts2" />
      <div className="TopTexts3">
        <div className="TopTexts">Tools</div>
        <div className="TopTexts">AWS Builder</div>
        <div className="TopTexts">Start Build</div>
        <div className="TopTexts">Build Supplies</div>
        <div className="TopTexts">Tooling</div>
        <div className="TopTexts">BlueHosting</div>
      </div>
      <div className="Paths">
        <div className="Path">Home</div>
        {arrow}
        <div className="Path">Hosting for all</div>
        {arrow}
        <div className="Path">Hosting</div>
        {arrow}
        <div className="Path">Hosting6</div>
        {arrow}
        <div className="Path">Hosting5</div>
      </div>
    </div>
  );
}
